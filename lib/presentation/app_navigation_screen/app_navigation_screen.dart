...
class AppNavigationScreen extends StatelessWidget {
  ...
  onTapLoginScreenThree(BuildContext context) {
  ...
  onTapGroupchart(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.groupChartScreen,
    );
  }
  ...
  onTapUnderprogress(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.underProgressScreen,
    );
  }

  onTapStudentprofile(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.studentProfileScreen,
    );
  }

  onTapFrame3607(BuildContext context) {
    NavigatorService.pushNamed(
      AppRoutes.frame3607Screen,
    );
  }

  onTapUnderprogresTwo(BuildContext context) {
    NavigatorService.pushNamed(
