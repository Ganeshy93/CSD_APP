import 'bloc/under_progres_two_bloc.dart';
import 'models/under_progres_two_model.dart';
import 'package:csd_flutter_application/core/app_export.dart';
import 'package:flutter/material.dart';

class UnderProgresTwoScreen extends StatelessWidget {
  static Widget builder(BuildContext context) {
    return BlocProvider<UnderProgresTwoBloc>(
        create: (context) => UnderProgresTwoBloc(UnderProgresTwoState(
            underProgresTwoModelObj: UnderProgresTwoModel()))
          ..add(UnderProgresTwoInitialEvent()),
        child: UnderProgresTwoScreen());
  }

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<UnderProgresTwoBloc, UnderProgresTwoState>(
